...
public class TransactionalEmailsApiTest {
     ...
     */
    @Test
    public void postPreviewSmtpEmailTemplatesTest() throws ApiException {
        FetchTemplatePreview fetchTemplatePreview = null;
        TemplatePreview response = api.postPreviewSmtpEmailTemplates(fetchTemplatePreview);
