...
public class DealsApiTest {
    ...
    public void crmDealsGetTest() throws ApiException {
        ...
        String sort = null;
        String sortBy = null;
        DealsList response = api.crmDealsGet(filtersAttributesDealName, filtersLinkedCompaniesIds, filtersLinkedContactsIds, modifiedSince, createdSince, offset, limit, sort, sortBy);
     ...
     */
    @Test
    public void crmDealsImportPostTest() throws ApiException {
        File file = null;
        String mapping = null;
        InlineResponse2004 response = api.crmDealsImportPost(file, mapping);
