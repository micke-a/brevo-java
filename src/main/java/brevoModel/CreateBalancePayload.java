...
public class CreateBalancePayload {
  ...
  public CreateBalancePayload balanceDefinitionId(String balanceDefinitionId) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Unique identifier (UUID) of the balance definition associated with the new balance.")
  ...
  if (o == null || getClass() != o.getClass()) {
    ...
    return ObjectUtils.equals(this.balanceDefinitionId, createBalancePayload.balanceDefinitionId);
  }

  @Override
  public int hashCode() {
    return ObjectUtils.hashCodeMulti(balanceDefinitionId);
  }
